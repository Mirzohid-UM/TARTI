...
class TestScoreAdmin(admin.ModelAdmin):
    list_display = ('user', 'citizenship', 'school_name', 'is_studying', 'study_level', 'current_activity')
    search_fields = ('school_name', 'user__username', 'citizenship')  # Foydalanuvchi username, maktab nomi va fuqarolik bo'yicha qidirish
